...
/* 这个用来设置是否支持磁盘盘符设置为1就可以通过相关函数读取或者设置磁盘的名字了 */
#define _USE_LABEL           1
...
/* 该选项用于设置是否支持长文件名（还需要_CODE_PAGE 支持），取值范围为 0~3。
 * 0，表示不支持长文件名，
 * 1~3 是支持长文件名，但是存储地方不一样，我们选择使用 3，动态分配长文件名的存储区域 */
...
/----------------------------------------------------------------------------*/
/* 磁盘数,用于设置 FATFS 支持的逻辑设备数目，我们使用 NAND FLASH 和 SD卡 */
#define _VOLUMES    2
