...
{
	xSemaphoreTake(WriteFlashMutex, portMAX_DELAY); //互斥锁闭锁
	...
	xSemaphoreGive(WriteFlashMutex); //互斥锁开锁
}
...
{
	xSemaphoreTake(ReadFlashMutex, portMAX_DELAY); //互斥锁闭锁
	...
	xSemaphoreGive(ReadFlashMutex); //互斥锁开锁
}
